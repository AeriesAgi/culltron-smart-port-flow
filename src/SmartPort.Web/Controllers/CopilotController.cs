    ...
    private static object ToJson(CopilotChatResponse? response)
    {
        if (response == null)
        {
            return new
            {
                ...
                summary = "I did not receive a question. Try asking about truck queues, ETA tracking, gate pressure, emissions or recommendations.",
                shortAnswer = "Choose a topic chip or type a scoped smart-port operations question.",
                intent = "empty",
                urgency = "Low",
                confidence = 100,
                affectedArea = "Smart Port Copilot",
                operationalReasoning = "No question was provided.",
                ...
                dataNote = "Local Offline-Safe Mode · no question provided",
                generatedBy = "Local",
